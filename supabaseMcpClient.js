...
const insertJob = async ({
  ...
  const query = `
    ...
    values (
      ...
      ${sqlString(location)},
      ${sqlString(pickupLocation)},
      ${sqlString(dropoffLocation)},
      ${sqlString(notes)},
    ...
    on conflict (call_sid) do update set
      ...
      pickup_location = coalesce(excluded.pickup_location, public.jobs.pickup_location),
      dropoff_location = coalesce(excluded.dropoff_location, public.jobs.dropoff_location),
