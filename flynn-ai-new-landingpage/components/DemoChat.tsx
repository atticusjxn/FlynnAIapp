        ...
        >
            ...
            <AnimatePresence mode='wait'>
                {showLeadCard && (
                    <motion.div 
                        ...
                        style={{ transform: "translateZ(80px) translateX(-85px)", x: contentX, y: contentY }}
                        initial={{ opacity: 0, x: -60, rotateY: -10 }}
                        animate={{ opacity: 1, x: 0, rotateY: 0 }}
                        exit={{ opacity: 0, x: -20, transition: { duration: 0.2 } }}
                        transition={{ type: "spring", stiffness: 200, damping: 15 }}
                        className="absolute top-48 -left-24 bg-white border-2 border-black p-4 w-60 shadow-[10px_10px_0px_0px_rgba(0,0,0,0.15)] z-[60] rounded-xl hidden md:block"
                    >
            ...
            <div ref={chatContainerRef} className="flex-1 overflow-y-auto p-4 space-y-6 bg-surface-50 relative scrollbar-hide">
                ...
                <AnimatePresence mode='popLayout'>
                    ...
                    >
                        <div
                        className={`max-w-[85%] p-3.5 text-sm font-medium leading-snug shadow-sm border-2 ${
                            msg.role === 'user'
