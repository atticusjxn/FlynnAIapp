          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              <div className="ml-10 flex items-center space-x-8">
                ...
                <Link to="/login" className="text-black hover:text-brand-500 transition-colors text-sm font-medium font-display tracking-wide uppercase">Login</Link>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-4 pt-4 pb-8 space-y-4">
              ...
              <Link to="/login" className="text-black block text-3xl font-display font-bold hover:text-brand-500" onClick={() => setMobileMenuOpen(false)}>Login</Link>
