            ...
            <div className="relative">
              ...
              >
                ...
                <div className="flex flex-wrap gap-4 items-center">
                  <button className="bg-brand-500 text-white hover:bg-brand-600 px-8 py-4 text-lg font-bold uppercase tracking-wide shadow-[6px_6px_0px_0px_#000000] transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_#000000] border-2 border-black">
                    Start Free Trial
                  </button>
                  <button className="flex items-center gap-2 px-8 py-4 font-bold text-black border-2 border-transparent hover:border-black transition-all">
                    <PlayCircle size={24} />
                    <span>View Demo</span>
                  </button>
                </div>
